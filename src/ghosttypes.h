...
public:
    ...
    void set_target(int pac_pos_x, int pac_pos_y, int pac_dir, char * tilemap){
        switch(this->get_state()){
            case 2: this->set_dir(this->shortest_distance_path(27, 0, tilemap,0,0));break;
            case 5: this->set_dir(this->shortest_distance_path(13, 13, tilemap,0,0));break;
            case 6: this->set_dir(this->shortest_distance_path(13, 11, tilemap,0,0));break;
